...
$r->get('/categorias/inserir', 'Php\Primeiroprojeto\Controllers\CategoriaController@inserir');

$r->post('/categorias/novo', 'Php\Primeiroprojeto\Controllers\CategoriaController@novo');
